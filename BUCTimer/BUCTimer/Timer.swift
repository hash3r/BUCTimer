...
private var runningTimers = Set<BTimer>()
...
open class BTimer : Hashable
{
    ...
    public init?(nanoseconds: UInt64, repeats: Int64, queue: DispatchQueue, _ completion: @escaping (BTimer) -> ())
    {
    ...
    public convenience init?(milliseconds: UInt64, repeats: Int64, queue: DispatchQueue, _ completion: @escaping (BTimer) -> ())
    {
    ...
    public convenience init?(seconds: UInt64, repeats: Int64, queue: DispatchQueue, _ completion: @escaping (BTimer) -> ())
    {
...
public func == (lhs: BTimer, rhs: BTimer) -> Bool
{
    return lhs === rhs
}
